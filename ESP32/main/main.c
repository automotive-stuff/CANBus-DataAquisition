...
/**
 * The code currently sends a four byte frame containing an incrementing UINT32 value. 
 * It continues to send these incremental frames as fast as the CANbus permits.
 */
